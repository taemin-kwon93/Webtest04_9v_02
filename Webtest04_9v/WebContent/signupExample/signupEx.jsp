...
<html>
<head>
<meta http-equiv="contentType" contentType="text/html; charset=EUC-KR">
<title>회원가입</title>
...
function checkIt(){
	...
	if(!userinput.jumin1.value || !userinput.jumin.value){
...
<body>
<div id="wrap">
 <form action="intputPro.jsp" name="userinput" onsubmit="return checkIt()" method="post">
 	<h1>회원가입</h1>
 	<div id="body">
 		<table width="500px;">
 			<colgroup>
 				...
 				<tr>
 					...
 					onclick="javascript:openConfirmid(this.form);" /></td>
 				<tr>
 					<th>비밀번호</th>
